    ...
    <div style="display: flex; align-items: flex-start; gap: 10px">
      ...
      <div style="max-width: 420px">
        ...
        {#if !$discordToken}
          ...
          <div style="font-size: 11px; color: var(--muted); text-align: center; margin: 1px 0">
        ...
        {:else}
          ...
          <button
            ...
            style="
              display: flex; align-items: center; justify-content: center; gap: 7px;
              width: 100%; padding: 8px 14px; background: #FF424D; color: #fff;
              border: none; border-radius: 6px;
              font-size: 13px; font-weight: 700; cursor: pointer; font-family: inherit;
            "
          >
          ...
          <button
            ...
            style="
              display: flex; align-items: center; justify-content: center; gap: 7px;
              width: 100%; padding: 8px 14px; background: #29ABE0; color: #fff;
              border: none; border-radius: 6px;
              font-size: 13px; font-weight: 700; cursor: pointer; font-family: inherit;
            "
          >
          ...
          <button
            ...
            style="
              width: 100%; padding: 7px 14px; background: var(--card); color: var(--muted);
              border: 1px solid var(--border); border-radius: 6px;
