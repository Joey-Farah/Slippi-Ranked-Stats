...
export const STAT_DESCRIPTIONS: Partial<Record<string, string>> = {
  ...
  edgeguard_success_rate:  "Of the times your opponent went offstage (past the ledge or below it), how often they failed to make it back and lost the stock. Excludes hits that launched them straight to the blast zone (no edgeguard needed).",
  ...
  recovery_success_rate:   "Of the times you went offstage (past the ledge or below it), how often you made it back to the stage or ledge without losing the stock. Excludes hits that launched you straight to the blast zone.",
