...
export const STAT_DESCRIPTIONS: Partial<Record<string, string>> = {
  ...
  edgeguard_success_rate:  "Of the times your opponent went offstage (below Y=−5), how often you landed a hit on them (or took the stock) before they made it back onto the stage.",
  ...
  recovery_success_rate:   "Of the times you went offstage (below Y=−5), how often you made it back to the ledge or onto the stage without losing the stock.",
